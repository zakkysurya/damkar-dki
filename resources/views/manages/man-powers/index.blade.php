...
<script type="text/javascript">
      ...
      $(function() {
            ajaxDataTable = initDataTable({
                  selector: '#data-table',
                  url: "{!! route('manages.man-powers.data-table') !!}",
                  columns: [{
                              data: 'DT_RowIndex',
                              orderable: false,
                              searchable: false,
            ...
            const EventsHandler = {
                  ...
                  ajax: {
                        ...
                        save: function(formData) {
                              $.ajax({
                                    url: "{!! route('manages.man-powers.store') !!}", // Endpoint Laravel
                                    type: 'POST',
                                    data: formData,
                        ...
                        show: function(encryptedId) {
                              $.ajax({
                                    url: "{!! route('manages.man-powers.show') !!}", // Endpoint Laravel
                                    type: 'get',
                                    data: {
                                          encryptedId
                                    },
                      ...
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-12 mb-2">
                            ...
                            <input 
                              type="text" 
                              value="${response.data.nama_lengkap}"
                              name="nama_lengkap" 
                              class="form-control"
                              placeholder="Masukan Nama Lengkap" />
                          </div>
                      ...
                      <div class="modal-footer d-flex justify-content-end">
                        ...
                        update: function(formData) {
                              $.ajax({
                                    url: "{!! route('manages.man-powers.update') !!}", // Endpoint Laravel
                                    type: 'POST',
                                    data: formData,
                                    processData: false, // Jangan proses data karena menggunakan FormData
                                    contentType: false, // Jangan set content-type secara otomatis
                        ...
                        destroy: function(encryptedId) {
                              $.ajax({
                                    url: "{!! route('manages.man-powers.destroy') !!}", // Pastikan ini di-render dengan benar
                                    type: 'POST',
                                    data: {
